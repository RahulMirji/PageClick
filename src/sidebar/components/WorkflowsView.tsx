...
import { listWorkflows, getCategoryEmoji, type WorkflowGroup } from '../utils/workflowStore'
...
const ICONS: Record<string, ReactNode> = {
    ...
    'check-circle': <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 11-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg>,
    'search': <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>,
    'book-open': <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z" /><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z" /></svg>,
    ...
    'play-circle': <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polygon points="10 8 16 12 10 16 10 8" /></svg>,
        ...
        return (
            <div className="workflows-view">
                ...
                <div className="workflows-loading">
                    {[1, 2, 3, 4, 5, 6].map(i => (
                        <div key={i} className="workflow-skeleton">
                            <div className="skeleton-icon-sq" />
                        ...
                        <div className="workflow-cards">
                            {group.workflows.map(wf => (
                                <button
                                    ...
                                    onClick={() => onRunWorkflow(wf.prompt)}
                                >
                                    ...
                                    <svg className="workflow-card-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
