...
function ConfirmDialog({ step, verdict, onConfirm, onCancel }: ConfirmDialogProps) {
    ...
    return (
        <div className="confirm-overlay">
            <div className="confirm-dialog">
                {/* Header */}
                <div className="confirm-header" style={{ borderBottomColor: colors.accent }}>
                ...
                <div className="confirm-body">
                    ...
                    {verdict.escalatedRisk && (
                        <p className="confirm-escalation">
                            ...
                            <strong style={{ color: colors.accent }}>{verdict.escalatedRisk}</strong>
                        </p>
                    )}
