          ...
          <div className="profile-usage-meter">
            <div className="profile-usage-bar">
              <div
                ...
                style={{
                  width: `${Math.min((requestCount / FREE_REQUEST_LIMIT) * 100, 100)}%`,
                }}
              />
            </div>
            <span className="profile-usage-text">
              {requestCount} / {FREE_REQUEST_LIMIT} free requests
            </span>
          </div>
  ...
  return (
    <div className="profile-view">
      ...
      {showSignOutConfirm && (
        ...
        >
          <div
            className="profile-signout-dialog"
          ...
          >
            ...
            <h3>Sign out?</h3>
            <p>
              You'll need to sign in again to access your conversations and
              unlimited requests.
            </p>
            <div className="profile-signout-actions">
              <button
                className="profile-signout-cancel"
                onClick={() => setShowSignOutConfirm(false)}
              >
                Cancel
              </button>
              <button className="profile-signout-confirm" onClick={onSignOut}>
                Sign Out
              </button>
            </div>
          </div>
