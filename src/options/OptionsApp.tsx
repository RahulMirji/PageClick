...
const MODELS: { id: ModelId; label: string; icon: string; desc: string }[] = [
    { id: 'gemini-3-pro', label: 'Gemini 3 Pro', icon: '💎', desc: 'Best quality, slower' },
    { id: 'kimi-k2.5', label: 'Kimi K2.5', icon: '🌙', desc: 'Fast, good reasoning' },
    { id: 'gpt-oss-20b', label: 'GPT-OSS 20B', icon: '⚡', desc: 'Balanced speed & quality' },
    { id: 'llama-4-scout', label: 'Llama 4 Scout', icon: '🦙', desc: 'Open-source, vision support' },
]
...
export default function OptionsApp() {
    ...
    const handleClearHistory = async () => {
        if (!confirm('Clear all local conversation history? This cannot be undone.')) return
        ...
        <div style={styles.page}>
            <div style={styles.container}>
                ...
                <section style={styles.section}>
                    ...
                    <p style={styles.sectionDesc}>Choose the AI model used for new conversations.</p>
                    <div style={styles.optionGrid}>
                        {MODELS.map((m) => (
                            <button
                                ...
                                style={{
                                    ...styles.optionCard,
                                    ...(settings.defaultModel === m.id ? styles.optionCardActive : {}),
                                }}
                            ...
                            >
                                ...
                                {settings.defaultModel === m.id && (
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#1a1a1a', flexShrink: 0 }}>
                ...
                <section style={styles.section}>
                    ...
                    <p style={styles.sectionDesc}>Manage your stored conversation history.</p>
